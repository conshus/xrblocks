...
import { WebViewOptions } from './components/WebView';
...
export type UIJsonNodeOptions = PanelOptions | TextViewOptions | IconViewOptions | ImageViewOptions | LabelViewOptions | TextButtonOptions | VideoViewOptions | WebViewOptions | ColOptions | GridOptions | RowOptions | OrbiterOptions | SpatialPanelOptions | IconButtonOptions;
